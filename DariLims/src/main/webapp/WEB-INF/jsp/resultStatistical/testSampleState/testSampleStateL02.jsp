...
<script type="text/javascript">
	$(function() {
		...
		ajaxComboForm("sales_dept_cd", "", "${session.dept_cd}", null, 'testSampleStateForm');
		ajaxComboForm("sales_user_id", $('#testSampleStateForm').find("#sales_dept_cd").val(), "${session.user_id}", "", 'testSampleStateForm');

		$("#sales_dept_cd option").not(":selected").attr("disabled", "disabled");	
		$("#sales_user_id option").not(":selected").attr("disabled", "disabled");

		$('#testSampleStateForm').find("#sales_dept_cd").change(function() {
			ajaxComboForm("sales_user_id", $('#testSampleStateForm').find("#sales_dept_cd").val(), "CHOICE", "", 'testSampleStateForm');
		});
