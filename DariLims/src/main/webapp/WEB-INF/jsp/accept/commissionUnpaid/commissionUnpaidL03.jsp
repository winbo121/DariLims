...
<script type="text/javascript">
	$(function() {
		...
		ajaxComboForm("sales_user_id", $('#commissionDetailForm').find("#sales_dept_cd").val(), "", "", 'commissionDetailForm');
		ajaxComboForm("dept_cd", "", "ALL", null, 'commissionDetailForm')
		...
		fnDatePickerImg('taxEdate');
	 	...
	 	//업체 상세목록
	 	commissionDetailGrid('accept/selectUnpaidSalesList.lims', 'commissionDetailForm', 'commissionDetailGrid');
	...
	function commissionDetailGrid(url, form, grid) {
		$('#' + grid).jqGrid({
			...
			gridComplete : function() {
				var sum1 = $("#" + grid).jqGrid('getCol', 'commission_amt_det', false, 'sum');
				var sum2 = $("#" + grid).jqGrid('getCol', 'deposit_amt', false, 'sum');
				var sum3 = $("#" + grid).jqGrid('getCol', 'default_amt', false, 'sum');
				$("#" + grid).jqGrid('footerData', 'set', {payment_method: '합&nbsp;&nbsp;계 : ', commission_amt_det:sum1, deposit_amt:sum2,default_amt:sum3} );
				
				$('#gbox_commissionDetailGrid table.ui-jqgrid-ftable tr:first').children('td').css('background-color', '#dfeffc');	
				$('#gbox_commissionDetailGrid table.ui-jqgrid-ftable tr:first').children('td').css('font-weight', 'normal'); 	
			},
	...
	<form id="commissionDetailForm" name="commissionDetailForm" onsubmit="return false;">
		...
		<table class="list_table" >
			...
			<tr>
				...
				<th>결제여부</th>	
				<td>								 
<!-- 					<select name="tax_invoice_flag"  class="w200px "> -->
<!-- 				    <option value="">전체</option> -->
<!-- 				    <option value="Y">결제완료</option> -->
<!-- 				    <option value="N">미결제</option> -->
<!--                     </select>					 -->
						<select name="paid"  class="w200px "> 
	 				    <option value="">전체</option> 
					    <option value="Yes">결제완료</option>
					    <option value="No">미결제</option> 
	                    </select>	
