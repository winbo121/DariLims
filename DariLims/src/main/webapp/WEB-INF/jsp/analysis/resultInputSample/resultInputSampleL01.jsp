		...
		//결과입력 엔터키 작동
 		window.onkeydown = function()	{
 			...
 			if(event.keyCode == 13){
				...
				fn_Result_ondblClickRow('resultGrid',String(lastCkhRowNum), '18');
				arrNumber=[];
			}
	...
	function btn_Save_onclick() {
		...
		if (c == 0) {
			...
			var data = fnGetGridCheckData(grid) +
						...
						'&menu_cd=' + $('#menu_cd').val();
			var test = $('#resultForm').find('#test_sample_seq').val();
