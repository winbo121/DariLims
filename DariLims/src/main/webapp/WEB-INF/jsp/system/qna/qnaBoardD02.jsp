...
<table  class="list_table" >
	...
	<tr>
		...
		<td colspan="3">
			...
			<c:if test="${PreDetail.file_nm != null && PreDetail.file_nm != ''}">
				<label id="file_name"><a href="system/qnaBoardDown.lims?board_no=${PreDetail.board_no}">${PreDetail.file_nm}</a></label>
			</c:if>
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td class="table_button">
			...
			<span class="button white mlargeg auth_save" id="btn_Sub_Add" onclick="fn_Sub_ViewPage('insert');">
			 ...
			 -->
			<span class="button white mlargeg auth_save" id="btn_Sub_Insert" onclick="btn_Insert_onclick('sub');">
