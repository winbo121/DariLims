...
<script type="text/javascript">
	...
	$(function() {
		...
		str_mtlr_no = stringList[1];
		deptCd = stringList[2];
		
		arr = str_mtlr_no.split(",");
	...
	function btn_Insert_onclick() {
		...
		var url = fn_getConTextPath()+'/insertReagentsGlassInOut.lims';
		// 		alert(param)
...
<div class="popUp">
	<div class="pop_area pop_intro">
		...
		<div id="newReagentsGlassInoutDiv">
				...
				<div class="sub_blue_01">
					<table  class="select_table" >
						<tr>
							...
							<td class="table_button">
								<span class="button white mlargeb auth_save" id="btn_Insert" onclick="btn_Insert_onclick();">
