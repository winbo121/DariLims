...
<script type="text/javascript">
	...
	$(function() {
		...
		grid('master/selectFeeGroupList.lims', 'form', 'grid');
	...
	function btn_Save_onclick() {
		...
		if (rowId == '0') {
			url = 'master/insertFeeGroup.lims';
			detail_Test_Item_Yn = 'N';
		} else {
			url = 'master/updateFeeGroup.lims';
				...
				<table  class="select_table" >
					<tr>
						...
						<td class="table_button" style="text-align: right; padding-right: 30px;">
							...
							<span class="button white mlargeb" id="btn_Cancel" onclick="btn_Cancel_onclick();">
